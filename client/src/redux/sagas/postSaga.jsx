...
function* addPostSaga(action) {
    try {
        const response = yield call(axios.post, `${import.meta.env.VITE_LOCALHOST}/post/addPost`, action.payload);
...
function* fetchPostsSaga() {
    try {
        const response = yield call(axios.get, `${import.meta.env.VITE_LOCALHOST}/post`);
...
function* fetchPostByIdSaga(action) {
    try {
        const response = yield call(axios.get, `${import.meta.env.VITE_LOCALHOST}/post/${action.payload}`);
...
function* updatePostSaga(action) {
    try {
        yield call(axios.put, `${import.meta.env.VITE_LOCALHOST}/post/updatePost/${action.payload.id}`, action.payload);
...
function* deletePostSaga(action) {
    try {
        yield call(axios.delete, `${import.meta.env.VITE_LOCALHOST}/post/deletePost/${action.payload}`);
