...
import { addCartStart, fetchCartByAccountidStart, updateQuantityStart } from '../../../redux/slices/cartSlice';
        ...
        <Main>
            <DetailContainer>
                ...
                <DetailArticle>
                    ...
                    <button
                        style={{
                            display: product.ProductColors[0].quantity > 0 && token ? 'block' : 'none',
                        }}
                ...
                {product.Comments.length > 0 ? (
                    product.Comments.map((comment) => (
                        <CommentCard key={comment.id}>
                            <Avatar>{comment.Account.username.charAt(0).toUpperCase()}</Avatar>
                            <CommentContent>
                                <CommentContentP>
