...
const statuses = ['Chờ phê duyệt', 'Đang đóng gói', 'Đang vận chuyển', 'Đã giao hàng', 'Đã hủy'];
...
const AllOrder = () => {
    ...
    const formattedOrders = orderStatus?.orders?.map((order) => ({
        ...order,
        key: order.id,
        ward: order.Ward?.name || 'N/A',
        district: order.District?.name || 'N/A',
        city: order.Province?.name || 'N/A',
    }));
    ...
    return (
        <div style={{ padding: '25px', position: 'relative' }}>
            ...
            >
                <Input.Search placeholder="Tìm kiếm đơn hàng..." style={{ width: 300, height: 40 }} />
