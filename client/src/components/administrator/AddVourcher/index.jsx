        ...
        try {
            ...
            await dispatch(
                addVourcherStart({
                    ...
                    image,
                    discount_amount: allData.discount_amount && Number(allData.discount_amount),
                    discount_percent: allData.discount_percent && Number(allData.discount_percent),
                    max_discount_amount: allData.max_discount_amount && Number(allData.max_discount_amount),
                    minimum_order_value: allData.minimum_order_value && Number(allData.minimum_order_value),
