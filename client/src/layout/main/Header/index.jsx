...
import { deleteNotifyStart, fetchNotifyStart } from '../../../redux/slices/notifySlice';
                    ...
                    <List.Item
                        actions={[
                            <TiDeleteOutline
                                ...
                                className="text-[20px] cursor-pointer transition-all hover:text-red-600"
                                style={{
                                    color: '#ff4d4f',
    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                <Popover content={notifyContent} trigger="click" overlayInnerStyle={{ padding: 0 }}>
                    <Badge
